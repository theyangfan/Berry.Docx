...
namespace Berry.Docx
{
    internal class DocumentGenerator
    {
        ...
        private void CreateParts(WordprocessingDocument document)
        {
            ...
            CoreFilePropertiesPart coreFilePropertiesPart = document.AddCoreFilePropertiesPart();
        ...
        {
            DocumentFormat.OpenXml.Wordprocessing.Document document1 = new DocumentFormat.OpenXml.Wordprocessing.Document() { MCAttributes = new MarkupCompatibilityAttributes() { Ignorable = "w14 w15 wp14" } };
            ...
            SectionProperties sectionProperties1 = new SectionProperties() { RsidR = "00275ADC" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "004B16AB" };
            Rsid rsid1 = new Rsid() { Val = "00275ADC" };
            Rsid rsid2 = new Rsid() { Val = "004B16AB" };
            Rsid rsid3 = new Rsid() { Val = "00803144" };
            Rsid rsid4 = new Rsid() { Val = "0085730C" };
            ...
            W15.PersistentDocumentId persistentDocumentId1 = new W15.PersistentDocumentId() { Val = "{41142942-D54E-4684-BDEC-BC8238FEF39D}" };
        ...
        private void GenerateCoreFilePropertiesPart(CoreFilePropertiesPart part)
        {
            System.Xml.XmlTextWriter writer = new System.Xml.XmlTextWriter(part.GetStream(System.IO.FileMode.Create), System.Text.Encoding.UTF8);
            string now = DateTime.Now.ToString("yyyy-MM-ddThh:mm:ssZ");
            writer.WriteRaw($"<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\r\n<cp:coreProperties xmlns:cp=\"http://schemas.openxmlformats.org/package/2006/metadata/core-properties\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" xmlns:dcterms=\"http://purl.org/dc/terms/\" xmlns:dcmitype=\"http://purl.org/dc/dcmitype/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"><dc:title></dc:title><dc:subject></dc:subject><dc:creator>Berry.Docx</dc:creator><cp:keywords></cp:keywords><dc:description></dc:description><cp:lastModifiedBy>Berry.Docx</cp:lastModifiedBy><cp:revision>3</cp:revision><dcterms:created xsi:type=\"dcterms:W3CDTF\">{now}</dcterms:created><dcterms:modified xsi:type=\"dcterms:W3CDTF\">{now}</dcterms:modified></cp:coreProperties>");
            writer.Flush();
            writer.Close();
        }
    }
